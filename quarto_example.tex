...
\hypertarget{html-version}{%
\section*{Html version}\label{html-version}}
\addcontentsline{toc}{section}{Html version}

This non-nested version does not work. Lorem ipsum dolor sit amet,
...
\faIcon{youtube} Scan the QR code to watch a video
...
This nesting works, though the sidenote starts a bit lower than
expected, and I'm not sure how to center the QR code. Adding fig-align
to the brackets does not work.
